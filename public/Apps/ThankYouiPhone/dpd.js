...
dpd.apps = dpd("/apps");
dpd.apps.on = function(ev, fn) {
  return dpd.on("apps" + ":" + ev, fn);
}
dpd.apps.once = function(ev, fn) {
  return dpd.once("apps" + ":" + ev, fn);
}
dpd.apps.off = function(ev, fn) {
  return dpd.off("apps" + ":" + ev, fn);
}
dpd.apps.rename = function (path, body, fn) {
  dpd.apps.exec("rename", path, body, fn);
}


dpd.thankyous = dpd("/thank-yous");
dpd.thankyous.on = function(ev, fn) {
  return dpd.on("thank-yous" + ":" + ev, fn);
}
dpd.thankyous.once = function(ev, fn) {
  return dpd.once("thank-yous" + ":" + ev, fn);
}
dpd.thankyous.off = function(ev, fn) {
  return dpd.off("thank-yous" + ":" + ev, fn);
}
dpd.thankyous.rename = function (path, body, fn) {
  dpd.thankyous.exec("rename", path, body, fn);
}

dpd.usersettings = dpd("/user-settings");
dpd.usersettings.on = function(ev, fn) {
  return dpd.on("user-settings" + ":" + ev, fn);
}
dpd.usersettings.once = function(ev, fn) {
  return dpd.once("user-settings" + ":" + ev, fn);
}
dpd.usersettings.off = function(ev, fn) {
  return dpd.off("user-settings" + ":" + ev, fn);
}
dpd.usersettings.rename = function (path, body, fn) {
  dpd.usersettings.exec("rename", path, body, fn);
}
